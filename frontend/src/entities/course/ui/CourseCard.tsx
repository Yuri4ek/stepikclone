...
import { courseCover } from '../lib/cover'
...
export function CourseCard({ course, actions, footer }: { course: CatalogCourse; actions?: ReactNode; footer?: ReactNode }) {
  ...
  return (
    <Card className="flex flex-col overflow-hidden">
      <div className="relative m-2 h-32 overflow-hidden rounded-[22px] p-5 text-white" style={{ backgroundImage: courseCover(course.id) }}>
