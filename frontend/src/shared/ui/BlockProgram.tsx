...
/**
 * Блочная программа Scratch / MakeCode, записанная текстом (формат пакета содержания):
 * одна строка — один блок, отступ в 4 пробела — вложенность, «конец» закрывает цикл или условие,
 * [Раздел] в начале строки — раздел палитры MakeCode, «← …» — пояснение на полях.
 * Рисуем как стопку блоков с «скобкой» у вложенных — ребёнку проще узнать то, что он видит в редакторе.
 */
interface Line {
  depth: number
  text: string
...
/** Числа и значения в круглых скобках — как «окошки» в блоках */
