import { api, type CatalogCourse, type NextStep } from '../../api'
import { useUser } from '../../auth/AuthContext'
import { formatPercent } from '../../lib/format'
import { useAsync } from '../../lib/useAsync'
import { resolveStepType } from '../../steps/registry'
import { StepTypeBadge } from '../../components/StepTypeBadge'
import { ButtonLink, Card, EmptyState, ErrorBox, Loader, ProgressBar, ScorePill } from '../../components/ui'
import { CourseCard, courseCover } from './CatalogPage'
...
async function loadDashboard() {
  ...
  const nexts = await Promise.all(mine.map((c) => api.catalog.next(c.id).catch(() => null)))
  return {
